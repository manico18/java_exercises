 ...
 * @author MATIAS
 */
public class EjercicioExt02POOServ {
    ...
    public static void main(String[] args) {
        ...
        c)-Método mostrar(): que nos permita mostrar el NIF (ocho dígitos, un guion
        ...
        caracteres la posición que corresponda al resto de la división para obtener
        la letra correspondiente.
        */
        
        NIFServicio f = new NIFServicio();
        NIF f1 = f.crearNif();
        f.mostrarNIF(f1);
