...
package ejerciciosprac04colecciones;
 ...
 * @author MATIAS
 */
public class EjerciciosPrac04Colecciones {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        pS.mostrarPeliculas(); 
        pS.peliculasMasDeUnaHora();
        pS.peliculasDuracionMayorAMenor(); 
        pS.peliculasDuracionMenorAMayor();
        pS.peliculasAlfabeticamenteTitulo();
        pS.peliculasAlfabeticamenteDirector();
