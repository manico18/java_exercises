...
package ejercicio06pooutilidades;
 ...
 * @author MATIAS
 */
public class Ejercicio06POOUtilidades {

    public static void main(String[] args) {
        /*
        Un profesor particular está dando cursos para grupos de cinco alumnos y 
        necesita un programa para organizar la información de cada curso. Para 
        ello, crearemos una clase entidad llamada Curso, cuyos atributos serán: 
