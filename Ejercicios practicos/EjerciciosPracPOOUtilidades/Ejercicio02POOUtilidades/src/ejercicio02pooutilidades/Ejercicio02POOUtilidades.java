...
package ejercicio02pooutilidades;
 ...
 * @author MATIAS
 */
public class Ejercicio02POOUtilidades {
    ...
    public static void main(String[] args) {
        ...
        La clase debe tener un constructor vacío, getters y setters.  En el 
        constructor vacío se usará el Math.random para generar los dos números. 
