...
public class Ejercicio03POO {
    ...
    public static void main(String[] args) {
        ...
        al main.
        f)Método restar(): calcular la resta de los números y devolver el resultado al 
        main.
        ...
        usuario el error se le informa al usuario. Si no, se hace la división y 
        ...
        Operacion cO = new Operacion(sca.nextInt(), sca.nextInt());

        System.out.println("Suma:" + cO.sumar(0) + " Resta:" + cO.restar(0)
        + " Multiplicación:" + cO.multiplicar(0) + " División:" + cO.dividir(0));
    }
