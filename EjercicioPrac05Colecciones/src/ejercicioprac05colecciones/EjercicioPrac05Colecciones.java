...
package ejercicioprac05colecciones;
 ...
 * @author MATIAS
 */
public class EjercicioPrac05Colecciones {
    ...
    public static void main(String[] args) {
        ...
        al usuario si quiere guardar otro país o si quiere salir, si decide salir,
        ...
        con un Iterator, se buscará el país en el conjunto y si está en el conjunto
        se eliminará el país que ingresó el usuario y se mostrará el conjunto. 
