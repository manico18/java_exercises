...
package ejercioprac01colecciones;
 ...
 * @author MATIAS
 */
public class EjercioPrac01Colecciones {
    ...
    public static void main(String[] args) {
        ...
        perro no se encuentra en la lista, se le informará al usuario y se mostrará
        la lista ordenada.
        */
        
        MascotaServicio r1 = new MascotaServicio();
